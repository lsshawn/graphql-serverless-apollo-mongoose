...
/* harmony import */ var _generated_prisma_client__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./generated/prisma-client */ "./src/generated/prisma-client/index.js");
/* harmony import */ var _generated_prisma_client__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_generated_prisma_client__WEBPACK_IMPORTED_MODULE_4__);
...
const Link = __webpack_require__(/*! ./resolvers/Link */ "./src/resolvers/Link.js");

const fs = __webpack_require__(/*! fs */ "fs");

const typeDefs = Object(apollo_server_express__WEBPACK_IMPORTED_MODULE_3__["gql"])(fs.readFileSync("./src/schema.graphql", "utf8").toString());
const resolvers = {
  Query: {
    hello: () => "world"
  },
...
const server = new apollo_server_express__WEBPACK_IMPORTED_MODULE_3__["ApolloServer"]({
  ...
  context: request => {
    return { ...request,
      prisma: _generated_prisma_client__WEBPACK_IMPORTED_MODULE_4__["prisma"]
    };
  }
});
